...
create index "IDX_COMMENT_USER" on "APP"."COMMENT"("USER_OID");
...
create index "IDX_COMMENT_MOVIE" on "APP"."COMMENT"("MOVIE_OID");
...
create index "IDX_USER_MOVIE_USER" on "APP"."USER_MOVIE"("USER_OID");
create index "IDX_USER_MOVIE_MOVIE" on "APP"."USER_MOVIE"("MOVIE_OID");
...
create index "IDX_MOVIE_ACTOR_MOVIE" on "APP"."MOVIE_ACTOR"("MOVIE_OID");
create index "IDX_MOVIE_ACTOR_ACTOR" on "APP"."MOVIE_ACTOR"("ACTOR_OID");
...
create index "IDX_MOVIE_DIRECTOR" on "APP"."MOVIE"("DIRECTOR_OID");
...
create index "IDX_MOVIE_CATEGORY" on "APP"."MOVIE"("CATEGORY_OID");
